 ...
 */
static lv_value_precise_t lv_anim_shift_divide(lv_value_precise_t v, lv_value_precise_t shift_unit)
{
    return v / shift_unit;
}
/**********************
...
lv_anim_t * lv_anim_start(const lv_anim_t * a)
{
    ...
    new_anim->current_value = new_anim->start_value;
...
lv_value_precise_t lv_anim_path_linear(const lv_anim_t * a)
{
     ...
     */
    new_value = lv_anim_shift_divide(new_value, (lv_value_precise_t)(1 << LV_ANIM_RES_SHIFT));
...
lv_value_precise_t lv_anim_path_bounce(const lv_anim_t * a)
{
     ...
     * Right shift of negative signed values is implementation-defined and typically rounds toward -inf.
     */
    new_value = lv_anim_shift_divide(new_value, (lv_value_precise_t)(1 << LV_BEZIER_VAL_SHIFT));
